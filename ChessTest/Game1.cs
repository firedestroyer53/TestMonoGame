...
public class Game1 : Game
{
    ...
    private static readonly List<Tuple<Piece, Vector2>> moveHistory = new();
    ...
    protected override void Initialize()
    {
        ...
        pieces.ForEach(board.PlacePiece); // place pieces on the board
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        if (mouseState.LeftButton == ButtonState.Pressed && !wasLeftButtonPressed)
        {
            ...
            if (selectedPiece == null ||
                (!selectedPiece.TestIsMoveValid(cellX, cellY) && selectedPiece.IsWhite == turn))
            {
                ...
                if (clickedPiece == null || clickedPiece != selectedPiece) possibleMoves.Clear();
    ...
    protected override void Draw(GameTime gameTime)
    {
                ...
                if (piece.IsWhite)
                    switch (pieceType)
                    {
                        case { } when pieceType == typeof(Pawn):
                            spriteBatch.Draw(
                                whitePawnTexture,
                                new Rectangle(piece.PieceX * cellSize + 12, piece.PieceY * cellSize + 10, cellSize - 24,
                                    cellSize - 20),
                                null,
                                white,
                                0f,
                        ...
                        case { } when pieceType == typeof(King):
                            spriteBatch.Draw(
                                whiteKingTexture,
                                new Rectangle(piece.PieceX * cellSize + 6, piece.PieceY * cellSize + 6, cellSize - 12,
                                    cellSize - 12),
                                null,
                                white,
                                0f,
        ...
        foreach (var move in possibleMoves)
            spriteBatch.Draw(
                defaultTexture,
                new Rectangle((int)move.X * cellSize + cellSize / 4, (int)move.Y * cellSize + cellSize / 4,
